#!/usr/bin/env python3
"""
Authenticated benchmark runner using Railway tokens.
Executes 10 real prompts against the live CrucibAI deployment.
"""
...
JWT_SECRET = "oStBCikiPJJHT039spWz1PJiSyJi0Wt2aBfTW7DwHPpHBtywxbNCl5JwryI0y7jF"
JWT_ALGORITHM = "HS256"

def create_auth_token():
    """Create a JWT token for authentication."""
    payload = {
        "sub": "benchmark-runner",
        "user_id": "benchmark-user",
        "email": "benchmark@crucibai.dev",
