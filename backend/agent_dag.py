...
Rules: Production-ready. Health checks on all services. Secrets via environment variables only.""",
    ...
    "Payment Setup Agent": {
        "depends_on": ["Stack Selector"],
        "system_prompt": "You are a Payment Setup Agent. Suggest PayPal integration: checkout, webhooks, subscription. Code or step list.",
    },
    "Monitoring Agent": {
        "depends_on": ["Deployment Agent"],
    ...
    "PayPal Subscription Agent": {
        ...
        "system_prompt": "You are a PayPal Subscription Agent. Suggest plans, metering, downgrade. Plain text.",
    },
    "Invoice Agent": {
        "depends_on": ["Payment Setup Agent"],
    ...
    "PayPal Integration Agent": {
        "depends_on": ["Payment Setup Agent"],
        "system_prompt": "You are a PayPal Integration Agent. Integrate PayPal.\n\nImplement:\n1. Checkout flow\n2. Subscription management\n3. Webhook handlers\n4. Invoice generation\n5. Tax calculation\n\nOutput: Backend routes + frontend integration",
    },
    "Subscription Management Agent": {
        "depends_on": ["PayPal Integration Agent"],
...
OPTIMIZED_SYSTEM_PROMPTS: Dict[str, str] = {
    ...
    "Payment Setup Agent": "Payment. PayPal checkout, webhooks.",
    ...
    "PayPal Subscription Agent": "PayPal. Plans, metering.",
