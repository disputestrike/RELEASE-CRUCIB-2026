...
AGENT_DAG: Dict[str, Dict[str, Any]] = {
    ...
    "ML Model Definition Agent": {"depends_on": ["ML Framework Selector Agent"], "system_prompt": "You are an ML Model Definition Agent. Define models: architecture (layers, units, activation), loss functions, metrics (accuracy, precision, recall, F1, MAE, MSE), regularization (dropout, L1/L2, batch norm). Output ONLY code. No markdown."},
