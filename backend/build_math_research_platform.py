...
try:
    from agent_recursive_learning import AgentMemory, PerformanceTracker, AdaptiveStrategy
except:
    AgentMemory = None
...
MATH_PROBLEMS = {
    "riemann_hypothesis": {
        ...
        "prize": "$1,000,000",
        "agents_needed": ["Math Specialist", "Backend Generation", "Visualization Agent", "Data Analysis Agent"]
    },
    "navier_stokes": {
        "name": "Navier-Stokes Equations",
        "description": "Do smooth solutions always exist in 3D, or can singularities form?",
        "prize": "$1,000,000",
        "agents_needed": ["Physics Agent", "Backend Generation", "Simulation Agent", "Visualization Agent"]
    },
    "yang_mills": {
        "name": "Yang-Mills Existence and Mass Gap",
        "description": "Prove that Yang-Mills theory has a positive mass gap",
        "prize": "$1,000,000",
        "agents_needed": ["Quantum Physics Agent", "Backend Generation", "Mathematical Analysis Agent", "Visualization Agent"]
    },
    "p_vs_np": {
        "name": "P versus NP",
        "description": "If a problem can be verified quickly, can it also be solved quickly?",
        "prize": "$1,000,000",
        "agents_needed": ["Algorithm Agent", "Backend Generation", "Complexity Analysis Agent", "Visualization Agent"]
    }
}
...
class MathResearchPlatformBuilder:
    ...
    def __init__(self):
        ...
        self.output_dir = Path("/home/ubuntu/CrucibAI-fresh/backend/generated_math_platform")
...
"""
            ...
            output = await self._call_agent("Backend Generation", problem['name'], prompt)
...
"""
            ...
            output = await self._call_agent("Frontend Generation", problem['name'], prompt)
