...
class RealSaaSBuilder:
    ...
    def __init__(self):
        ...
        self.client = CerebrasClient(api_key=self.cerebras_key) if self.cerebras_key else None
    ...
    async def build(self) -> Dict[str, Any]:
        ...
        await asyncio.gather(
            self._run_agent("Requirements Clarifier", "Define requirements for 100-feature SaaS"),
    ...
    async def _run_agent(self, agent_name: str, task: str) -> str:
        ...
        try:
            ...
            if isinstance(validation_result, tuple) and len(validation_result) == 3:
                ...
                is_valid = validation_result if isinstance(validation_result, bool) else True
                parsed = output
                error = None
