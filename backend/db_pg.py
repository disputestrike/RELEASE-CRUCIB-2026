...
ALTER TABLE projects ADD COLUMN IF NOT EXISTS doc JSONB NOT NULL DEFAULT '{}';
...
CREATE TABLE IF NOT EXISTS simulation_claims (id TEXT PRIMARY KEY, doc JSONB NOT NULL DEFAULT '{}');
...
CREATE TABLE IF NOT EXISTS simulation_trust_snapshots (id TEXT PRIMARY KEY, doc JSONB NOT NULL DEFAULT '{}');
CREATE TABLE IF NOT EXISTS simulation_population_models (id TEXT PRIMARY KEY, doc JSONB NOT NULL DEFAULT '{}');
...
CREATE TABLE IF NOT EXISTS simulation_replay_events (id TEXT PRIMARY KEY, doc JSONB NOT NULL DEFAULT '{}');
