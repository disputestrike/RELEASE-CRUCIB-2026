...
class EmailService:
    ...
    def __init__(self):
        ...
        self.configured = all([self.smtp_host, self.smtp_username, self.smtp_password])
    ...
    async def send_welcome_email(
        self, user_email: str, first_name: str, login_url: str
    ) -> bool:
        """Send welcome email"""
        html_body = self._render_template(
            EmailTemplate.WELCOME, {"first_name": first_name, "login_url": login_url}
        )

        return await self.send_email(
            to_email=user_email, subject="Welcome to CrucibAI!", html_body=html_body
        )

    async def send_password_reset_email(
        self, user_email: str, first_name: str, reset_url: str
    ) -> bool:
    ...
    async def send_email_verification(
        self, user_email: str, first_name: str, verification_url: str
    ) -> bool:
