    ...
    async def generate_image(
        ...
        try:
            ...
            if fallback:
                ...
                return {
                    "success": True,
                    "url": self.FALLBACK_IMAGES.get(image_type, self.FALLBACK_IMAGES["feature_1"]),
                    "used_fallback": True,
                    "error": None
                }
    ...
    async def generate_video(
        ...
        try:
            ...
            if self.together_api_key:
                ...
                logger.warning(f"Together.ai video generation failed: {result.get('error')}")
            ...
            if fallback:
                ...
                return {
                    "success": True,
                    "url": self.FALLBACK_VIDEOS.get(video_type, self.FALLBACK_VIDEOS["feature"]),
                    "used_fallback": True,
                    "error": None
                }
