...
class IntentClassifier:
    ...
    DIMENSION_KEYWORDS = {
        ...
        "legal": ["legal", "law firm", "contract review", "case management", "matter management"],
        "education": ["education", "school", "student", "course", "lms", "learning management"],
        "erp": ["erp", "inventory", "procurement", "purchase order", "warehouse", "supply chain"],
        "iot": ["iot", "device telemetry", "sensors", "industrial telemetry"],
        ...
        "plugin_integration": ["plugin", "integration plugin", "extension plugin"],
        ...
        "high_scale": ["million users", "high scale", "high-scale", "high traffic", "large scale"],
        "security_critical": ["security-critical", "sensitive data", "encryption", "zero trust"],
