...
def _recommended_fix(check_id: str, ok: bool, **ctx) -> str:
    ...
    return fixes.get(check_id, "See issues[] for this preflight run; fix listed dependencies or use documented skip flags for dev.")
...
async def build_preflight_report() -> Dict[str, Any]:
    ...
    checks.append({
        ...
        "recommended_fix": _recommended_fix("node", node_ok or skip_node_verify_env()),
    })
    ...
    return {
        ...
        "env_flags": {
            ...
            "CRUCIBAI_SKIP_NODE_VERIFY": os.environ.get("CRUCIBAI_SKIP_NODE_VERIFY", ""),
            "CRUCIBAI_SKIP_BROWSER_PREVIEW": os.environ.get("CRUCIBAI_SKIP_BROWSER_PREVIEW", ""),
