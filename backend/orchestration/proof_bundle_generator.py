...
class ProofBundleGenerator:
    ...
    async def _copy_workspace_meta(
        self, proof_dir: str, job_state: Dict[str, Any]
    ) -> None:
    ...
    async def _write_manifest(
        self, proof_dir: str, job_id: str, job_state: Dict[str, Any]
    ) -> None:
        """Write job manifest."""
        manifest = {
            "job_id": job_id,
    ...
    async def _write_verification_results(
        self, proof_dir: str, job_state: Dict[str, Any]
    ) -> None:
    ...
    async def _write_deployment_info(
        self, proof_dir: str, job_state: Dict[str, Any]
    ) -> None:
        ...
        if deployment:
            deploy_info = {
                ...
                "deployed_at": str(
                    deployment.get("deployed_at", datetime.utcnow().isoformat())
                ),
            }
    ...
    def _extract_phase_state(
        self, job_state: Dict[str, Any], phase: str
    ) -> Dict[str, Any]:
