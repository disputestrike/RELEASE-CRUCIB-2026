...
SYSTEM_SKILLS = [
    ...
    },
    {
        ...
        "short_desc": "Auth, PayPal billing, user dashboard, multi-tenant - launch-ready in hours",
        "trigger_prompt": "Build a SaaS MVP with PayPal billing, user auth, and admin dashboard",
        "is_featured": True,
        "install_count": 2100,
        "rating_avg": 4.9,
        "tags": ["saas", "paypal", "auth", "billing"],
        "preview_url": None,
    },
    {
        ...
        "short_desc": "Product catalog, cart, PayPal checkout, inventory, order management",
        "trigger_prompt": "Build an e-commerce store with product catalog, cart, and PayPal checkout",
        "is_featured": False,
        "install_count": 633,
        "rating_avg": 4.6,
        "tags": ["ecommerce", "paypal", "inventory"],
        "preview_url": None,
    },
    {
    ...
    },
    {
        ...
        "short_desc": "Calendar scheduling, availability, reminders, PayPal deposits",
