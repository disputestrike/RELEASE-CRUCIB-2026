...
class ArtifactBuilder:
    ...
    async def build(
        ...
        *,
        ...
        if render_pdf:
            try:
                from ....services.pdf_renderer import pdf_renderer                pdf_path = await pdf_renderer.render(
        ...
        if render_slides:
            try:
                from ....services.slides_renderer import slides_renderer                slides_path = await slides_renderer.render(
                    content=content,
                    title=title,
