...
Usage:
    ...
    from ....services.mcp_client import registry as mcp_registry    result = await mcp_registry.dispatch("mcp.slack.send",
                                         {"channel": "#eng", "text": "hi"})
"""
...
def bootstrap_registry() -> McpRegistry:
    ...
    from ....services.mcp_adapters import slack as slack_adapter    from ....services.mcp_adapters import github as github_adapter    from ....services.mcp_adapters import notion as notion_adapter
