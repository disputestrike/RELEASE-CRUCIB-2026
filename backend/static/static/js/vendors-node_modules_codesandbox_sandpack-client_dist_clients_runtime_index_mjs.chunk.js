(self["webpackChunkfrontend"] = self["webpackChunkfrontend"] || []).push([["vendors-node_modules_codesandbox_sandpack-client_dist_clients_runtime_index_mjs"],{
...
/* harmony export */ });
/* harmony import */ var _utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils-52664384.mjs */ "./node_modules/@codesandbox/sandpack-client/dist/utils-52664384.mjs");
/* harmony import */ var dequal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dequal */ "./node_modules/dequal/dist/index.mjs");
/* harmony import */ var _base_80a1f760_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../base-80a1f760.mjs */ "./node_modules/@codesandbox/sandpack-client/dist/base-80a1f760.mjs");
/* harmony import */ var mime_db__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! mime-db */ "./node_modules/mime-db/index.js");
/* harmony import */ var outvariant__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! outvariant */ "./node_modules/outvariant/lib/index.mjs");
...
var Protocol = /** @class */function () {
  function Protocol(type, handleMessage, protocol) {
    ...
    this._disposeMessageListener = this.protocol.channelListen(function (msg) {
      return (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__._)(_this, void 0, void 0, function () {
        var message, result, response, err_1, response;
        return (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.a)(this, function (_a) {
          switch (_a.label) {
            case 0:
...
var IFrameProtocol = /** @class */function () {
  ...
  IFrameProtocol.prototype.dispatch = function (message) {
    ...
    this.frameWindow.postMessage((0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.h)({
      $id: this.channelId,
      codesandbox: true
    }, message), this.origin);
  };
...
var entries = Object.entries(mime_db__WEBPACK_IMPORTED_MODULE_3__);
for (var _i = 0, entries_1 = entries; _i < entries_1.length; _i++) {
  var _a$1 = entries_1[_i],
    mimetype = _a$1[0],
    entry = _a$1[1];
...
function getTemplate(pkg, /* eslint-disable @typescript-eslint/no-explicit-any */
modules) {
  if (!pkg) {
    return "static";
  }
  ...
  var totalDependencies = (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.i)((0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.i)([], Object.keys(dependencies), true), Object.keys(devDependencies), true);
...
var SandpackRuntime = /** @class */function (_super) {
  (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.g)(SandpackRuntime, _super);
  function SandpackRuntime(selector, sandboxSetup, options) {
    ...
    if (typeof selector === "string") {
      ...
      (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.n)(element, "The element '".concat(selector, "' was not found"));
        ...
        case "action":
          {
            if (mes.action === "show-error") {
              _this.errors = (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.i)((0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.i)([], _this.errors, true), [(0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.e)(mes)], false);
            }
            break;
          }
        case "done":
  ...
  SandpackRuntime.prototype.updateOptions = function (options) {
    if (!(0,dequal__WEBPACK_IMPORTED_MODULE_1__.dequal)(this.options, options)) {
      this.options = options;
      this.updateSandbox();
    }
  };
  SandpackRuntime.prototype.updateSandbox = function (sandboxSetup, isInitializationCompile) {
    ...
    this.sandboxSetup = (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.h)((0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.h)({}, this.sandboxSetup), sandboxSetup);
    var files = this.getFiles();
    var modules = Object.keys(files).reduce(function (prev, next) {
      var _a;
      return (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.h)((0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.h)({}, prev), (_a = {}, _a[next] = {
        code: files[next].code,
        path: next
      }, _a));
    }, {});
    var packageJSON = JSON.parse((0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.b)(this.sandboxSetup.dependencies, this.sandboxSetup.devDependencies, this.sandboxSetup.entry));
    try {
      packageJSON = JSON.parse(files["/package.json"].code);
    } catch (e) {
      console.error((0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.c)("could not parse package.json file: " + e.message));
    }
    ...
    this.dispatch((0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.h)((0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.h)({}, this.options), {
      type: "compile",
      codesandbox: true,
      version: 3,
      ...
      logLevel: (_d = this.options.logLevel) !== null && _d !== void 0 ? _d : _utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.S.Info,
  ...
  SandpackRuntime.prototype.getCodeSandboxURL = function () {
    ...
    var paramFiles = Object.keys(files).reduce(function (prev, next) {
      var _a;
      return (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.h)((0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.h)({}, prev), (_a = {}, _a[next.replace("/", "")] = {
        content: files[next].code,
        isBinary: false
      }, _a));
    }, {});
  ...
  SandpackRuntime.prototype.getFiles = function () {
    ...
    if (sandboxSetup.files["/package.json"] === undefined) {
      return (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.d)(sandboxSetup.files, sandboxSetup.dependencies, sandboxSetup.devDependencies, sandboxSetup.entry);
    }
  ...
  SandpackRuntime.prototype.initializeElement = function () {
    ...
    (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.n)(this.element.parentNode, "The given iframe does not have a parent.");
    this.element.parentNode.replaceChild(this.iframe, this.element);
  };
  return SandpackRuntime;
}(_base_80a1f760_mjs__WEBPACK_IMPORTED_MODULE_2__.S);
...
//# sourceMappingURL=vendors-node_modules_codesandbox_sandpack-client_dist_clients_runtime_index_mjs.chunk.js.map