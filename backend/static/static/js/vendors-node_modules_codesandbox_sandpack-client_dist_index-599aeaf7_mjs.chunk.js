"use strict";
(self["webpackChunkfrontend"] = self["webpackChunkfrontend"] || []).push([["vendors-node_modules_codesandbox_sandpack-client_dist_index-599aeaf7_mjs"],{
...
var PreviewController = class {
  constructor(options) {
    var _options$indexFiles;
    this.initPromise = null;
    this.baseUrl = new URL(options.baseUrl);
    this.getFileContent = options.getFileContent;
    this.indexFiles = (_options$indexFiles = options.indexFiles) !== null && _options$indexFiles !== void 0 ? _options$indexFiles : ["index.html", "index.html"];
  }
  ...
  destroy() {
    if (this.initPromise) {
      ...
      p.then(val => {
        ...
        const foundElements = document.body.querySelectorAll("src=\"".concat(url, "\""));
...
/* harmony import */ var static_browser_server__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! static-browser-server */ "./node_modules/static-browser-server/out/lib/main.js");
/* harmony import */ var _consoleHook_59e792cb_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./consoleHook-59e792cb.mjs */ "./node_modules/@codesandbox/sandpack-client/dist/consoleHook-59e792cb.mjs");
...
/* harmony import */ var dequal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! dequal */ "./node_modules/dequal/dist/index.mjs");
...
var SandpackStatic = /** @class */function (_super) {
  (0,_utils_52664384_mjs__WEBPACK_IMPORTED_MODULE_0__.g)(SandpackStatic, _super);
  function SandpackStatic(selector, sandboxSetup, options) {
    ...
    _this.emitter = new _consoleHook_59e792cb_mjs__WEBPACK_IMPORTED_MODULE_2__.E();
    _this.previewController = new static_browser_server__WEBPACK_IMPORTED_MODULE_1__.PreviewController({
        ...
        if (filepath.endsWith(".html") || filepath.endsWith(".htm")) {
          try {
            ...
            content = _this.injectScriptIntoHead(content, {
              script: _consoleHook_59e792cb_mjs__WEBPACK_IMPORTED_MODULE_2__.c,
              scope: {
                channelId: (0,_consoleHook_59e792cb_mjs__WEBPACK_IMPORTED_MODULE_2__.g)()
              }
            });
          } catch (err) {
  ...
  SandpackStatic.prototype.updateSandbox = function (setup, _isInitializationCompile) {
    ...
    var modules = (0,_consoleHook_59e792cb_mjs__WEBPACK_IMPORTED_MODULE_2__.f)(setup.files);
    /**
...
//# sourceMappingURL=vendors-node_modules_codesandbox_sandpack-client_dist_index-599aeaf7_mjs.chunk.js.map