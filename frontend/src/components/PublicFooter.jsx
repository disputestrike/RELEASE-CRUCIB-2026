  ...
  return (
    <footer className="mt-24 py-12 px-6 border-t border-white/10 bg-kimi-bg">
      ...
      <div className="max-w-2xl mx-auto text-center mb-16">
        <h2 className="text-2xl md:text-3xl font-bold text-kimi-text mb-3">Your idea is inevitable. Start today.</h2>
        <p className="text-kimi-muted mb-6">Describe what you want to build. Ship it today.</p>
