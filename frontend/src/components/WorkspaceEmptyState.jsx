...
const PROMPT_SETS = {
  ...
  ecommerce: [
    'Build an e-commerce store with product catalog, cart, and PayPal checkout',
    'Create a marketplace with seller dashboard and buyer reviews',
    'Build a subscription box shop with recurring billing',
  ],
  saas: [
    'Build a SaaS MVP with auth, PayPal billing, and user dashboard',
  ...
  default: [
    ...
    'Build an e-commerce store with cart and PayPal checkout',
  ],
};
