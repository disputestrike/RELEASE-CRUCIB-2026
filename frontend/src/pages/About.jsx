    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-6 text-[#1A1A1A] leading-relaxed">
          <p>CrucibAI is Inevitable AI: the platform where intelligence doesn&apos;t just act, it makes outcomes inevitable. We help developers and teams plan, build, and ship applications using a swarm of agents and sub-agents—plan-first, full transparency, production-ready code.</p>

          <h2 className="text-xl font-semibold text-[#1A1A1A] mt-8 mb-3">What we do</h2>
          <p>We provide a plan-first build experience: you describe what you want, and our agent swarm handles planning, frontend and backend generation, database design, testing, images and videos, and deployment guidance. You get production-ready code, one-click deploy options, and full control to edit and extend your project.</p>
