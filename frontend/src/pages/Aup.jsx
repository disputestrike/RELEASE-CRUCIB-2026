    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A]">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-6 text-[#1A1A1A] leading-relaxed">
          ...
          <p>For AUP or enforcement questions, contact <a href="mailto:appeals@crucibai.com" className="text-[#1A1A1A] hover:text-[#333] underline">appeals@crucibai.com</a> or the support address provided in the app.</p>
        </div>
