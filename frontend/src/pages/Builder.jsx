      ...
      return (
        <button
          ...
          className={`w-full flex items-center gap-2 px-2 py-1.5 text-sm hover:bg-gray-100 rounded transition ${
            selectedFile === item.path ? 'bg-[#F3F1ED] text-[#1A1A1A]' : 'text-gray-700'
          }`}
    ...
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <header className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-4 flex-shrink-0">
        <div className="flex items-center gap-4">
          <button onClick={() => navigate('/app/workspace')} className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-3">
          {buildPhase === 'complete' && (
            <>
              ...
              <button className="flex items-center gap-2 px-4 py-1.5 text-sm bg-[#1A1A1A] text-white rounded-lg hover:bg-[#333] transition">
            ...
            return (
              <div
                ...
                className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-sm whitespace-nowrap ${
                  status === 'complete' ? 'bg-[#F3F1ED] text-[#1A1A1A]' :
                  status === 'running' ? 'bg-[#F5F5F4] text-[#666666] animate-pulse' :
          ...
          {buildPhase === 'idle' ? (
            ...
            <div className="flex-1 flex items-center justify-center p-8">
              <div className="max-w-2xl w-full text-center">
                <div className="w-16 h-16 bg-[#F3F1ED] rounded-2xl flex items-center justify-center mx-auto mb-6">
                ...
                <form onSubmit={(e) => { e.preventDefault(); generateCode(); }} className="space-y-4">
                  <textarea
                    ...
                    className="w-full h-32 px-4 py-3 border border-gray-200 rounded-xl focus:border-[#666666] focus:ring-2 focus:ring-black/10 outline-none resize-none text-lg"
                ...
                <div className="mt-8 grid grid-cols-2 gap-4 text-left">
                  {[
                    ...
                    <button
                      ...
                      className="p-3 border border-gray-200 rounded-lg hover:border-black/15 hover:bg-[#F5F5F4] transition text-sm text-gray-600"
                    >
                      {example}
                    </button>
                  ))}
          ...
          <div className="w-[500px] flex flex-col bg-white">
            ...
            <div className="flex-1 border-b border-gray-200 flex flex-col">
              ...
              <div className="flex-1 bg-white p-4">
                {buildPhase === 'complete' ? (
                  <div className="h-full border border-gray-200 rounded-lg overflow-hidden bg-gradient-to-br from-[#FAFAF8] to-[#F5F5F4] flex items-center justify-center">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-[#F3F1ED] rounded-full flex items-center justify-center mx-auto mb-4">
                      ...
                      {previewUrl && (
                        <a 
                          ...
                          className="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-[#1A1A1A] text-white rounded-lg text-sm hover:bg-[#333]"
                        >
              ...
              <form onSubmit={handleChatSubmit} className="p-3 border-t border-gray-200">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-[#666666] outline-none"
