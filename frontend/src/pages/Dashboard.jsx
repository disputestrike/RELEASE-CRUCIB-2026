...
const SKILLS = [
  ...
  { icon: '🛒', name: 'E-Commerce', skill_name: 'ecommerce-builder', desc: 'Product catalog, cart, checkout with Braintree payments', prompt: 'Build an e-commerce store with product catalog, cart, and Braintree checkout' },
  { icon: '📊', name: 'SaaS Dashboard', skill_name: 'saas-mvp-builder', desc: 'Auth, subscription billing, user management, metrics', prompt: 'Build a SaaS MVP with Braintree billing, user auth, and admin dashboard' },
