...
const API_SECTIONS = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/api/billing/create-order', desc: 'Create a PayPal checkout order', body: '{ "price_id": "price_pro_one_time" }', response: '{ "status": "created", "paypal_order_id": "..." }' },
