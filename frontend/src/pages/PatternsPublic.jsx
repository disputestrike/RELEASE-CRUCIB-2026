...
const FALLBACK_PATTERNS = [
  ...
  { id: 'paypal-checkout', name: 'PayPal Checkout Flow', desc: 'Pricing cards, checkout orders, webhook handling.', category: 'payments', usage_count: 890, tokens_saved: 60000 },
          ...
          {CATEGORIES.map((c) => (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm transition ${
                category === c.id ? 'bg-[#F3F1ED] text-[#1A1A1A] border border-[#1A1A1A]/20' : 'border border-zinc-800 text-zinc-400 hover:text-[#1A1A1A]'
              }`}
            >
