    ...
    <div className="max-w-4xl mx-auto" data-testid="project-builder">
              ...
              >
                <div className="flex items-start gap-4">
                  <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                    formData.project_type === type.id ? 'bg-[#F3F1ED]' : 'bg-white/5'
                  }`}>
                    <type.icon className={`w-6 h-6 ${
                      formData.project_type === type.id ? 'text-[#1A1A1A]' : 'text-[#666666]'
                    }`} />
                  </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:border-[#666666] focus:ring-1 focus:ring-black/10 outline-none transition"
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:border-[#666666] focus:ring-1 focus:ring-black/10 outline-none transition resize-none"
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:border-[#666666] outline-none"
            ...
            <div className="flex items-center gap-6">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  className="w-5 h-5 rounded border-white/20 bg-white/5 text-[#1A1A1A] focus:ring-black/10"
                />
      ...
      {step === 3 && (
        ...
        >
          ...
          {error && (
            <div className="mb-6 p-4 bg-[#F5F5F4] border border-black/10 rounded-lg text-[#666666]">
              ...
              {(error.includes('Acceptable Use') || error.toLowerCase().includes('violates')) && (
                <p className="mt-2 text-sm">
                  <Link to="/aup" className="text-[#1A1A1A] hover:underline">View Acceptable Use Policy</Link>
          ...
          <div className="p-6 bg-[#0a0a0a] rounded-xl border border-white/10 space-y-6">
            ...
            <div className="p-4 bg-[#F5F5F4] border border-black/10 rounded-lg">
              ...
              {(user?.token_balance || 0) < (selectedType?.tokens || 0) && (
                <p className="mt-3 text-sm text-[#666666]">Insufficient tokens. Please purchase more.</p>
              )}
            </div>
          </div>
        </motion.div>
      ...
      <div className="flex items-center justify-between mt-8">
        ...
        {step < 3 ? (
          <button
            ...
            disabled={!canProceed()}
            className="flex items-center gap-2 px-6 py-3 bg-[#1A1A1A] hover:bg-[#333] disabled:opacity-50 disabled:cursor-not-allowed rounded-lg font-medium transition "
          ...
          <button
            ...
            className="flex items-center gap-2 px-8 py-3 bg-[#1A1A1A] hover:bg-[#333] disabled:opacity-50 disabled:cursor-not-allowed rounded-lg font-medium transition"
