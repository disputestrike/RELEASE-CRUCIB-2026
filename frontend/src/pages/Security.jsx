      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="space-y-6 text-[#1A1A1A] leading-relaxed">
          ...
          <ul className="list-disc pl-6 space-y-2 text-[#333]">
            ...
            <li><strong className="text-[#1A1A1A]">Secrets:</strong> API keys and webhook secrets are stored securely. We do not expose webhook secrets in list endpoints. PayPal webhooks are processed server-side.</li>
            ...
            <li><strong className="text-[#1A1A1A]">Payments:</strong> We use PayPal for payments. Card data is handled by PayPal; we do not store full card numbers.</li>
          </ul>
