    ...
    return (
      <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A] flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          <AlertCircle className="w-12 h-12 text-[#666666] mx-auto mb-4" />
          ...
          <Link to="/" className="text-[#1A1A1A] hover:text-[#333]">Back to CrucibAI</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#FAFAF8] text-[#1A1A1A] p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-wrap gap-2 text-sm">
          ...
          {project.live_url && (
            <a href={project.live_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 px-3 py-1 bg-gray-200 text-[#1A1A1A] rounded-full hover:bg-[#F3F1ED]">
        ...
        <Link to="/app/workspace" className="inline-block mt-4 text-[#1A1A1A] hover:text-[#333]">Go to CrucibAI</Link>
      </div>
    </div>
  );
}
