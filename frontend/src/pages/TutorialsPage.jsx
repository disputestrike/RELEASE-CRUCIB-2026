...
const TUTORIALS = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Describe your mobile app', content: 'Example: "Build a fitness tracking app. Features: workout logging, progress charts, rest timer, exercise library with animations. Dark theme with gray accents."' },
