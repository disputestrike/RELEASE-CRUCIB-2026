...
- Generated at: `2026-04-25T06:05:18.228659+00:00`
- Mode: `simulated`
- Total runs: `3`
- Success rate: `100.00%`
- Average score: `96.20`
- Average time (seconds): `54.33`
...
| --- | ---: | ---: | ---: | --- |
| full_app_build | 3 | 100.00% | 96.20% | 85-90 |

## Provider Pool

- Execution mode: `single_key`
- Pool size (configured keys): `0`
- Keys exercised: `0`
- Failover events: `0`
- Total LLM calls: `0`
- Note: Results produced using single-key Cerebras provider execution.
