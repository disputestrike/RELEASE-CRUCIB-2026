...
- Generated at: `2026-04-08T13:21:15.997382+00:00`
- Prompt count: `50`
- Passed count: `50`
- Pass rate: `100.00%`
- Average score: `100.00`
- Required pass rate: `90.00%`
- Required average score: `90.00`
- Overall: `PASS`

| Case | Category | Score | Status | Failed stages |
| --- | --- | ---: | --- | --- |
| `saas_dashboard` | saas | 100.00 | PASS | - |
| `marketplace` | marketplace | 100.00 | PASS | - |
| `booking_app` | booking | 100.00 | PASS | - |
| `crm_pipeline` | crm | 100.00 | PASS | - |
| `ai_chat` | ai | 100.00 | PASS | - |
| `ecommerce_store` | commerce | 100.00 | PASS | - |
| `workflow_automation` | automation | 100.00 | PASS | - |
| `bring_your_code_repair` | byoc | 100.00 | PASS | - |
| `internal_tool` | internal | 100.00 | PASS | - |
| `landing_page` | marketing | 100.00 | PASS | - |
| `project_management` | productivity | 100.00 | PASS | - |
| `learning_platform` | education | 100.00 | PASS | - |
| `healthcare_intake` | healthcare | 100.00 | PASS | - |
| `finance_budget` | finance | 100.00 | PASS | - |
| `restaurant_ordering` | food | 100.00 | PASS | - |
| `real_estate_listing` | real_estate | 100.00 | PASS | - |
| `community_forum` | community | 100.00 | PASS | - |
| `event_management` | events | 100.00 | PASS | - |
| `support_ticketing` | support | 100.00 | PASS | - |
| `inventory_management` | operations | 100.00 | PASS | - |
| `portfolio_site` | portfolio | 100.00 | PASS | - |
| `nonprofit_donor` | nonprofit | 100.00 | PASS | - |
