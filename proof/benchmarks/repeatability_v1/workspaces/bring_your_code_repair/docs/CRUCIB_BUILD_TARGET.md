...
Default Auto-Runner path — SPA, Sandpack preview, FastAPI sketch, SQL, verifiers.

Goal (excerpt): Build a bring-your-code repair workspace with import instructions, issue triage dashboard, file review notes, and continue-improving flow.
