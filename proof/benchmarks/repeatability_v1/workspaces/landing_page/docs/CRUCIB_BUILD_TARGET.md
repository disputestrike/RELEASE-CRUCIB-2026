...
Vite SPA oriented to landing-style pages; same stack, copy and layout tuned for sites.

Goal (excerpt): Build a conversion landing page for a product launch with sections, routing-safe preview, saved feedback notes, and export-ready files.
