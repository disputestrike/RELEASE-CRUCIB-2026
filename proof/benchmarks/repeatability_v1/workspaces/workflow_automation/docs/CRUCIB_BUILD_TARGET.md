# CrucibAI — build target for this job

**Agents & automation**

Crew-style sketches, workflow docs, and hooks into the fixed DAG — not a custom LangGraph runtime.

Goal (excerpt): Build a workflow automation hub where a user can describe a workflow, review a run_agent step, track status, and inspect proof.
